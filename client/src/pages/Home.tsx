...
const media = {
  ...
  social1: "https://n0mcghihytcwg4vv.public.blob.vercel-storage.com/prova%20social%201.jpeg",
  social2: "https://n0mcghihytcwg4vv.public.blob.vercel-storage.com/prova%20social%202.jpeg",
  social3: "https://n0mcghihytcwg4vv.public.blob.vercel-storage.com/prova%20social%203.jpg",
  social4: "https://n0mcghihytcwg4vv.public.blob.vercel-storage.com/prova%20social%204.JPG",
  social5: "https://n0mcghihytcwg4vv.public.blob.vercel-storage.com/prova%20social%205.JPG",
  heroTexture: "https://n0mcghihytcwg4vv.public.blob.vercel-storage.com/onyx-kinetic-hero-texture_ba87412e.jpg",
  motionSurface: "https://n0mcghihytcwg4vv.public.blob.vercel-storage.com/onyx-kinetic-motion-surface_360571bd.jpg",
  weave: "https://n0mcghihytcwg4vv.public.blob.vercel-storage.com/onyx-kinetic-weave-detail_d5009e99.jpg",
  mark: "https://n0mcghihytcwg4vv.public.blob.vercel-storage.com/onyx-kinetic-mark_90671358.jpg",
  kitPair: "https://n0mcghihytcwg4vv.public.blob.vercel-storage.com/download_c0184161.jpg",
  sizeGuide: "https://n0mcghihytcwg4vv.public.blob.vercel-storage.com/Guiadetamanho_06d276bb.jpg",
  kitContents: "https://n0mcghihytcwg4vv.public.blob.vercel-storage.com/o_que_voce_recebe_0262ab15.jpg",
};
...
function trackInitiateCheckout() {
  if (typeof window === "undefined") return;
  const trackingWindow = window as typeof window & { fbq?: (...args: string[]) => void };
...
function trackCheckoutClick(location: string) {
  trackEvent("click_cta", { location, destination: "checkout" });
  ...
  return (
    <div className="site-shell">
      <header className={`site-header ${headerSolid ? "site-header--solid" : ""}`}>
        ...
        <div className="header-offer"><PurchaseCTA label="COMPRAR AGORA" location="header" className="header-cta" /><span className="header-shipping-note">Frete grátis para todo o Brasil</span></div>
